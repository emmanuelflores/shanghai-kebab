...
Particle::Particle(const float& x, const float& y, const float& r):
...
Particle::Particle(const float& x, const float& y, const float& r, const int& xs, const int& ys):xvalue(x),yvalue(y),radius(r),
xstep(xs),ystep(ys){
